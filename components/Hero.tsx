...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    // Auto-detect user country to show relevant text
  ...
  const handleAndroidDownload = () => {
    if (ANDROID_DOWNLOAD_LINK) {
      // Use window.open for better mobile behavior (avoids blocking main thread)
      window.open(ANDROID_DOWNLOAD_LINK, '_blank');
    } else {
      alert("Download link coming soon! Please check back later.");
    }
  };
  
  const handleIOSDownload = () => {
    if (IOS_DOWNLOAD_LINK) {
  ...
  return (
    <section id="home" className="relative w-full min-h-screen pt-32 pb-20 flex items-center overflow-hidden bg-gaming-bg">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-gaming-primary/15 rounded-full blur-[120px] opacity-40"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-gaming-secondary/15 rounded-full blur-[120px] opacity-40"></div>
        
        {/* Tech Grid Pattern - Subtler */}
      ...
      {/* Fixed Container Width and Spacing */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 z-10 relative grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="text-center lg:text-left order-2 lg:order-1">
          <div className="inline-flex items-center px-4 py-1.5 mb-6 border border-gaming-secondary/30 rounded-full bg-gaming-secondary/10 backdrop-blur-md shadow-[0_0_15px_rgba(14,165,233,0.2)]">
            <Sparkles className="w-3.5 h-3.5 text-gaming-secondary mr-2 animate-pulse" />
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
            Join <span className="text-white font-bold">100k+ gamers</span> in daily leagues for BGMI, Free Fire & COD. Available on Android & iOS.
          </p>
          
          <div className="flex flex-col items-center lg:items-start space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                {/* Android Button - Enhanced Visibility */}
                ...
                {/* iOS Button - Enhanced Visibility */}
                <div className="relative group flex-1">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 text-xs md:text-sm text-gray-500 font-medium w-full">
              ...
              <div className="flex items-center bg-white/5 px-3 py-1 rounded-lg border border-white/5">
                <Shield className="w-3.5 h-3.5 mr-2 text-gaming-secondary" />
                100% Secure
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-sm aspect-square flex flex-col items-center justify-center">
                ...
                <div className="relative w-full bg-[#0a0a0f]/80 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-6 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden group flex flex-col justify-between min-h-[380px]">
                    ...
                    <div className="relative flex justify-between items-center z-10">
                         ...
                         <Target className="text-white/30 w-5 h-5" />
                    </div>

                    {/* Content: Central Stats */}
                ...
                {/* Active Users Floating Badge - Fixed Position */}
